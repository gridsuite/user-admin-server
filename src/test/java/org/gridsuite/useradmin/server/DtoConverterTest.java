...
class DtoConverterTest implements WithAssertions {
    ...
    class ConverterOfUserInfos {
        ...
        void testConversionToDtoOfUserInfos() {
            ...
            UserProfileEntity profile = new UserProfileEntity(UUID.randomUUID(), "a profile", null, null, null, null, null, null, 5, 6, null, null, null, null, null,
                    null, null, null, null, null,
                    null, null, null, null);
            ...
            assertThat(UserInfosEntity.toDtoWithDetail(new UserInfosEntity(uuid, "sub_user", profile, null, null), 5, 2, 6, null, null, null,
                    ...
                    null, null, null))
                    .as("dto result")
                    .isEqualTo(new UserInfos("sub_user", null, null, "a profile", 5, 2, 6, null, null, null,
                            null, null, null, null, null,
                            null, null, null, null));
            ...
            assertThat(UserInfosEntity.toDtoWithDetail(new UserInfosEntity(uuid, "sub_user", profile, null, Set.of(group1, group2)), 5, 2, 6, null, null, null,
                    ...
                    .isEqualTo(new UserInfos("sub_user", null, null, "a profile", 5, 2, 6, null, null, null,
                            null, null, null, null, null,
                            null, null, null, Set.of("group1", "group2")));
        }
