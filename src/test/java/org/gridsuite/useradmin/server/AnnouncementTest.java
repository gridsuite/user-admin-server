...
class AnnouncementTest {
    ...
    void testCreateAnnouncement() throws Exception {
        ...
        mockMvc.perform(post("/" + UserAdminApi.API_VERSION + "/announcements/{id}", announcementToBeCreated.id())
        ...
        MvcResult result = mockMvc.perform(post("/" + UserAdminApi.API_VERSION + "/announcements/{id}", announcementToBeCreated.id())
